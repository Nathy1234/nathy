...
public class Personagem {
    ...
    private static final int DESCOLAMENTO = 3;
    ...
    public final void atirar() {
        int posicaoTiroX = this.posicaoEmX + this.larguraImagem + 100;
        int posicaoTiroY = this.posicaoEmY + (this.alturaImagem / 2) + 100;

        Tiro tiro = new Tiro(posicaoTiroX, posicaoTiroY);
        this.tiros.add(tiro);
